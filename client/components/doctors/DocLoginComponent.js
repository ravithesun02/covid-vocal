...
import {signin} from '../../api/api-doc';
...
class DocLogin extends Component{
    ...
    userSignin=async(event)=>{
        ...
        if(res.ok)
        {
            ...
            auth.authenticate(tokenData.token,'doc_jwt',()=>{
                this.setState({
                    isLoggedIn:true
                });
            })
...
export default withStyles(styles)(DocLogin);